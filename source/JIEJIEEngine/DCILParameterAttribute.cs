...
namespace JIEJIE
{
    internal class DCILParameterAttribute : DCILCustomAttribute
    {
        public const string ConstAttributeTypeName = "System.ParamArrayAttribute";
        public DCILParameterAttribute()
        {
        }
